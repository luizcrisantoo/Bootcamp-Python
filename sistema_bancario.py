...
while True:
    # exibir menu e ler opcao
    opcao = input(menu).lower()

    if opcao == 'd':

        # deposito - somente valores positivos | devem ser armazenados no extrato
        ...
        # saque - permitido somente 3 saques por dia | limite por saque = R$ 500,00 | devem ser armazenados no extrato
        # caso o usuário não tenha saldo suficiente, exibir uma mensagem "saldo insuficiente"
